...
public class ProductManagementController {
    ...
    private Map<String, Object> modifyProduct(HttpServletRequest request) {
        Map<String, Object> modelMap = new HashMap<>();
        boolean statusStage = HttpServletRequestUtil.getBoolean(request, "statusChange");
        if (!statusStage && !CodeUtil.checkVerifyCode(request)) {
            modelMap.put("success", false);
            modelMap.put("errMsg", "验证码输入错误");
            return modelMap;
        }
        ...
        try {
            ...
            modelMap.put("success", false);
            modelMap.put("errMsg", request.toString());
            return modelMap;
        }
        try {
            String productStr = HttpServletRequestUtil.getString(request, "productStr");
        ...
        if (product != null) {
            try {
                ...
                if (statusStage) product.setEnableStatus(ProductStateEnum.DOWN.getState());
